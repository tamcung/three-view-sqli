...
echo "  - The dataset already lives at data/synthesized_dataset.jsonl"
echo "    and is split into data/splits/{train,val,test}.jsonl."
echo "  - To regenerate from scratch, see README.md (scripts/*.py pipeline)."
echo "============================================================"
